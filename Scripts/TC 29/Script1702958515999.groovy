...
WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input2'), '2345')

WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input3'), '3456')

WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input4'), '4567')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_/input_Transfer Amount_qbf-input small ng-un_ba31be'), 'mNG83uaVC7o=')

WebUI.setText(findTestObject('Object Repository/Page_/input__input5'), '02')

WebUI.setText(findTestObject('Object Repository/Page_/input__input6'), '23')
