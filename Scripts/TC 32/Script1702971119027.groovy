...
WebUI.click(findTestObject('Object Repository/Page_/a_Mobile bill'))

WebUI.click(findTestObject('Object Repository/Page_/body_YOUR TRUSTED FAMILY BANK              _cd9ddc'))

WebUI.setText(findTestObject('Object Repository/Page_/input_Transfer Amount_qbf-input small ng-un_ba31be'), '299')
