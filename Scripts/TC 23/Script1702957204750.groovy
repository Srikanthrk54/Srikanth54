...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_/input_Transfer Amount_qbf-input small ng-un_ba31be'), 'rkhzDQ/J9rM=')

WebUI.setText(findTestObject('Object Repository/Page_/input__input5'), '09')

WebUI.setText(findTestObject('Object Repository/Page_/input__input6'), '29')
