...
WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input2'), '3456')

WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input3'), '3456')

WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input4'), '9009')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_/input_Transfer Amount_qbf-input small ng-un_ba31be'), 'Bb8/GkEFW0g=')

WebUI.setText(findTestObject('Object Repository/Page_/input__input5'), '11')

WebUI.setText(findTestObject('Object Repository/Page_/input__input6'), '30')
