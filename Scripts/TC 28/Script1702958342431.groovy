...
WebUI.click(findTestObject('Object Repository/Page_/div_Make a Transfer'))
...
WebUI.setText(findTestObject('Object Repository/Page_/input_Memo_qbf-memo-input'), 'Bill')
