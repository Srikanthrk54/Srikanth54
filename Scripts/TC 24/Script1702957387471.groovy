...
WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input1'), '9876')

WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input2'), '8765')

WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input3'), '7654')

WebUI.setText(findTestObject('Object Repository/Page_/input_Credit Card Number_input4'), '6543')
...
WebUI.setText(findTestObject('Object Repository/Page_/input__input5'), '01')

WebUI.setText(findTestObject('Object Repository/Page_/input__input6'), '24')
